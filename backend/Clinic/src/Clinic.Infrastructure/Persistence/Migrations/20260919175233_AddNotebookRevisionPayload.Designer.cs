...
namespace Clinic.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919175233_AddNotebookRevisionPayload")]
    partial class AddNotebookRevisionPayload
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.AuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ActorStaffId", "OccurredAtUtc");
                    ...
                    b.ToTable("ClinicalTestRequests", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ClinicalTestRequests_Lifecycle", "([Status] = 0 AND [UploadedAtUtc] IS NULL AND [ReviewedAtUtc] IS NULL AND [ReviewedByDoctorId] IS NULL) OR ([Status] IN (1, 2) AND [UploadedAtUtc] IS NOT NULL AND [RequestedAtUtc] <= [UploadedAtUtc] AND [ReviewedAtUtc] IS NULL AND [ReviewedByDoctorId] IS NULL) OR ([Status] = 3 AND [UploadedAtUtc] IS NOT NULL AND [ReviewedAtUtc] IS NOT NULL AND [ReviewedByDoctorId] IS NOT NULL AND [RequestedAtUtc] <= [UploadedAtUtc] AND [UploadedAtUtc] <= [ReviewedAtUtc])");
                        });
                });

            modelBuilder.Entity("Clinic.Domain.Entities.ClinicalTestResultAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ClinicalTestRequestId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTimeOffset>("LinkedAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid>("PatientAttachmentId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("PatientAttachmentId")
                        .IsUnique();

                    b.HasIndex("ClinicalTestRequestId", "LinkedAtUtc");

                    b.ToTable("ClinicalTestResultAttachments", (string)null);
                });
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Medication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GenericNameAr", "Strength", "Unit", "Form", "Route")
                        .IsUnique()
                        .HasFilter("[GenericNameAr] IS NOT NULL");

                    b.HasIndex("GenericNameEn", "Strength", "Unit", "Form", "Route")
                        .IsUnique()
                        .HasFilter("[GenericNameEn] IS NOT NULL");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.NotebookRevision", b =>
                {
                    ...
                    b.ToTable("NotebookRevisions", null, t =>
                        {
                            t.HasCheckConstraint("CK_NotebookRevisions_Payload", "([Kind] = 0 AND [StoredFileId] IS NULL) OR ([Kind] = 1 AND [StoredFileId] IS NOT NULL AND [ClientDraftId] IS NOT NULL AND [OriginDeviceId] IS NOT NULL)");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Prescription", b =>
                {
                    ...
                    b.Property<string>("FinalizedByStaffId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ReleasedByStaffId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");

                    b.Property<Guid?>("ReplacedByPrescriptionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ReplacesPrescriptionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReplacedByPrescriptionId")
                        .IsUnique()
                        .HasFilter("[ReplacedByPrescriptionId] IS NOT NULL");

                    b.HasIndex("ReplacesPrescriptionId")
                        .IsUnique()
                        .HasFilter("[ReplacesPrescriptionId] IS NOT NULL");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.PrescriptionItem", b =>
                {
                    ...
                    b.HasIndex("PrescriptionId", "DisplayOrder");

                    b.ToTable("PrescriptionItems", (string)null);
                });

            modelBuilder.Entity("Clinic.Domain.Entities.StoredFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Visit", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("SuggestedFollowUpAtUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("DoctorId", "OccurredAtUtc");

                    b.HasIndex("PatientId", "OccurredAtUtc");

                    b.ToTable("Visits", null, t =>
                        {
                            t.HasCheckConstraint("CK_Visits_Lifecycle", "([Status] = 0 AND [FinalizedAtUtc] IS NULL AND [FinalizedByStaffId] IS NULL) OR ([Status] = 1 AND [FinalizedAtUtc] IS NOT NULL AND [FinalizedByStaffId] IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Clinic.Domain.Entities.VisitAmendment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AmendmentText")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("VisitAmendments", (string)null);
                });

            modelBuilder.Entity("Clinic.Domain.Entities.VitalMeasurement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("RespiratoryRateBreathsPerMin")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clinic.Infrastructure.Authentication.MobileStaffSession", b =>
                {
                    ...
                    b.Property<string>("ProtectedPrincipal")
                        .IsRequired()
                        .HasMaxLength(8192)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("MobileStaffSessions", (string)null);
                });
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.ClinicalTestResultAttachment", b =>
                {
                    b.HasOne("Clinic.Domain.Entities.ClinicalTestRequest", null)
                        .WithMany()
                        .HasForeignKey("ClinicalTestRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Clinic.Domain.Entities.PatientAttachment", null)
                        .WithMany()
                        .HasForeignKey("PatientAttachmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Prescription", b =>
                {
                    ...
                    b.HasOne("Clinic.Domain.Entities.Prescription", null)
                        .WithMany()
                        .HasForeignKey("ReplacedByPrescriptionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Clinic.Domain.Entities.Prescription", null)
                        .WithMany()
                        .HasForeignKey("ReplacesPrescriptionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.PrescriptionItem", b =>
                {
                    b.HasOne("Clinic.Domain.Entities.Medication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Visit", b =>
                {
                    ...
                    b.Navigation("VitalMeasurements");
                });
